...
class ManagerMISDetail extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (params.id !== nextProps.match.params.id) {
      this.setState({
        ...
        selectedProductId: nextProps.match.params.id
      });

      this.getProductById(nextProps.match.params.id);
      this.getClientProducts(nextProps.match.params.clientId);
      this.getProductStockList(nextProps.match.params.id, "ThisMonth");
      this.getProductStockSummary(nextProps.match.params.id, "ThisMonth");
    }
  }
...
export default ManagerMISDetail;
