...
class ManagerWasteMISDetail extends Component {
  ...
  componentDidMount() {
    ...
    // Load the Server with the date range
            ...
            <div className="row">
              ...
              <div className="col-lg-8" ref={el => (this.componentRef = el)}>
                <header>
                  ...
                  <h2 style={{ fontSize: 22 }}>Waste Summary</h2>
                </header>
...
export default ManagerWasteMISDetail;
